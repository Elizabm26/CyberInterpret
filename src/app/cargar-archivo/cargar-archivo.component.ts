          ...
          properties: {
            ...
            estadoGeneral: Schema.object({
              properties: {
                ...
                generalDescription: Schema.string({ description: 'A partir del gráfico circular titulado "Estado General" y del gráfico de barras "Cumplimiento por Categoría", genera un análisis descriptivo detallado con el siguiente contenido: Porcentaje general de cumplimiento, cumplimiento parcial y no cumplimiento a nivel global, tal como se visualiza en el gráfico circular. Para cada categoría (Identificar, Proteger, Detectar, Responder, Recuperar): Muestra el porcentaje que corresponde a "Cumple", "Parcial" y "No cumple" según el gráfico de barras. Explica por qué se alcanza ese nivel de cumplimiento en cada subcategoría. Describe qué prácticas, controles o elementos evidencian el cumplimiento, el cumplimiento parcial o el incumplimiento en cada caso. Finalmente, realiza una conclusión global que relacione los niveles de cumplimiento por categoría con el estado general mostrado en la gráfica circular.' })
              }
            }),
